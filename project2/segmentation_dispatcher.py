...
def add_main_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--config_path', type=str, default='grid_search_segmentation.json',
        help='Path to the grid search JSON config file'
    )
    parser.add_argument(
        '--log_dir', type=str, default='./segmentation_logs',
    ...
    parser.add_argument( '--grid_search_results_path', type=str, default='./segmentation_logs/grid_results.csv',
        help='Path to save grid search summary CSV'
    )
...
def launch_experiment(args: argparse.Namespace, experiment_config: dict, problem) -> dict:
    ...
    try:
        ...
        return {**experiment_config, "train_iou": None, "val_iou": None}
